...
* What can you with the values assign read + write permissions?
  * A: You can see the contents of a file and overwrite them.
...
* Why is managing file ownership important?
  * A: To prevent unauthorized access, modification or general unintentional damage caused to certain files. IE: Files that contain sensitive information or are part of a critical system.
